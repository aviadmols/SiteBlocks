...
| `EMBED_SCRIPT_BASE_URL`    | *(לא חובה)* | כתובת הבסיס שמופיעה בסקריפט ה־embed באדמין. אם לא מוגדר: משתמשים בכתובת הבקשה הנוכחית (ב־Railway יוצג ה־URL של Railway). שימושי כשמריצים מקומית ורוצים שהסקריפט המועתק יצביע לכתובת הפרודקשן. |
